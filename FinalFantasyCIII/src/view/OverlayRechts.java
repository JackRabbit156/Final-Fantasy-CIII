...
public class OverlayRechts extends Pane {
	...
	/**
	 * Stellt ein Overlay-Menü dar, um die Informationen eines Spielercharakters
	 * anzuzeigen. Dieses Menü enthält den Avatar des Charakters, den Namen, die
	 * Lebenspunkteleiste und die Manaleiste. Diese chars werden im Rechten Overlay
	 * Menü angezeigt
	 *
	 * @param spielerCharakter Der Spielercharakter, für den das Overlay erstellt
	 *                         wird.
	 *
	 * @author Rode
	 * @since 06.12.2023
	...
	public OverlayRechts(List<Button> buttons, ViewController viewController, PartyController partyController) {
		...
		Image optionButtonNichtGedrueckt = new Image("buttons/menuRechtsButtonOptionNotPressed.png", 50, 50, true,
				true);
