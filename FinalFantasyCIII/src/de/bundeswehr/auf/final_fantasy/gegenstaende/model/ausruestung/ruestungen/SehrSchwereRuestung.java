...
public class SehrSchwereRuestung extends Ruestung {
    ...
    public SehrSchwereRuestung(int stufe) {
        ...
        this.setVerteidigung(stufe * ZufallsZahlenGenerator.zufallsZahlIntAb1Inklusive(5));
        this.setMagischeVerteidigung(stufe * ZufallsZahlenGenerator.zufallsZahlIntAb1Inklusive(1));
        this.setResistenz(stufe * ZufallsZahlenGenerator.zufallsZahlIntAb1Inklusive(3));
        this.setMaxGesundheitsPunkte(stufe * ZufallsZahlenGenerator.zufallsZahlIntAb0Inklusive(6));
        this.setMaxManaPunkte(stufe * ZufallsZahlenGenerator.zufallsZahlIntAb0Inklusive(2));
