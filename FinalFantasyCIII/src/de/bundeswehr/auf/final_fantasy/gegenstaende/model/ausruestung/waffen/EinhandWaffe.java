...
public class EinhandWaffe extends Waffe {
    ...
    public EinhandWaffe(int stufe) {
        ...
        this.setGenauigkeit(stufe * ZufallsZahlenGenerator.zufallsZahlAb0Inklusive(3));
        this.setBeweglichkeit(stufe * ZufallsZahlenGenerator.zufallsZahlAb0Inklusive(5));
