...
public class SoeldnerEntlassenView extends VBox {
    ...
    /**
     * Konstruktor für die SoeldnerEntlassenView-Klasse.
     * Die Klasse SoeldnerEntlassenView zeigt die grafische Benutzeroberfläche zum Entlassen von Söldnern in der Taverne an.
     *
     ...
     * @since 05.12.2023
     */
    public SoeldnerEntlassenView(TaverneController taverneController, PartyController partyController) {
