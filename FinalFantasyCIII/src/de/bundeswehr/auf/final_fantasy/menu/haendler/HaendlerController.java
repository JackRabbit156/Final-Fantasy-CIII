...
import de.bundeswehr.auf.final_fantasy.gegenstaende.model.material.*;
...
public class HaendlerController {
     ...
     * @since 04.12.23
     */
    public void waffenKaufen(Waffe waffe) {
     ...
     * @since 04.12.23
     */
    public void ruestungKaufen(Ruestung ruestung) {
     ...
     * @since 04.12.23
     */
    public void accessoireKaufen(Accessoire accessoire) {
     ...
     * @since 04.12.23
     */
    public void verbrauchsgegenstandkaufen(Verbrauchsgegenstand verbrauchsgegenstand) {
        int anzahl = 1;
     ...
     * @since 04.12.23
     */
    public void materialienkaufen(Material material) {
        int anzahl = 1;
     ...
     * @since 04.12.23
     */
    public void waffenVerkaufen(Waffe waffe) {
     ...
     * @since 04.12.23
     */
    public void ruestungVerkaufen(Ruestung ruestung) {
     ...
     * @since 04.12.23
     */
    public void accessoireVerkaufen(Accessoire accessoire) {
     ...
     * @since 05.12.23
     */
    public void verbrauchsgegenstandverkaufen(Verbrauchsgegenstand verbrauchsgegenstand) {
        int anzahl = 1;
     ...
     * @since 05.12.23
     */
    public void materialienVerkaufen(Material material) {
        int anzahl = 1;
     ...
     * @since 04.12.23
     */
    public void waffenZurueckkaufen(Waffe waffe) {
        if (partyController.getPartyGold() >= waffe.getKaufwert()) {
            partyController.getParty().getAusruestungsgegenstandInventar().ausruestungsgegenstandHinzufuegen(waffe);
     ...
     * @since 04.12.23
     */
    public void ruestungZurueckkaufen(Ruestung ruestung) {
        if (partyController.getPartyGold() >= ruestung.getKaufwert()) {
            partyController.getParty().getAusruestungsgegenstandInventar().ausruestungsgegenstandHinzufuegen(ruestung);
     ...
     * @since 04.12.23
     */
    public void accessoireZurueckkaufen(Accessoire accessoire) {
        if (partyController.getPartyGold() >= accessoire.getKaufwert()) {
            partyController.getParty().getAusruestungsgegenstandInventar().ausruestungsgegenstandHinzufuegen(accessoire);
     ...
     * @since 05.12.23
     */
    public void verbrauchsgegenstandZurueckkaufen(Verbrauchsgegenstand verbrauchsgegenstand) {
        int anzahl = 1;
     ...
     * @since 04.12.23
     */
    public void materialZurueckkaufen(Material material) {
        int anzahl = 1;
