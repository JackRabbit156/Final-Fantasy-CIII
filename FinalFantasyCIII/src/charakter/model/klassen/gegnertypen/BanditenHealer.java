...
public class BanditenHealer extends Feind {

    public BanditenHealer(int partyLevel) {
        super(partyLevel);
        this.setName("Banditen-Healer");
        ...
        this.setGrafischeDarstellung("Dummy Banditen-Healer");
